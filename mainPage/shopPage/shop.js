  ...
  function displayInventory(){
	  ["player", "shop"].forEach(e => {
		  ...
		  for (let eachItem in eInventaire) {
			  ...
			  itemElement.className = `inventory-item rarity-${thisItem.rarity ? thisItem.rarity.toLowerCase() : "common"}`;
  
			  const imgElement = document.createElement("img");
			  imgElement.src = thisItem.image;
			  imgElement.alt = thisItem.name;
			  itemElement.appendChild(imgElement);
  
			  const titleElement = document.createElement("div");
			  titleElement.className = "item-title";
			  titleElement.textContent = thisItem.name;
			  ...
			  basicInfo.textContent = `Price: ${itemPrice}`;
			  ...
			  itemElement.appendChild(inputquantité);
  
			  if (e == "player") {
				  var parent = document.getElementById("container");
				  parent.appendChild(itemElement); // Add the item element to the player container
			  }
			  else {
				  var parentM = document.getElementById("containerMagasin");
				  parentM.appendChild(itemElement); // Add the item element to the shop container
			  }
		  }
	  });
  }
